 ...
 * Generated at: 2019-11-26 13:43:40 UTC
...
public final class diary_005fwrite_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<div id=\"in\">\r\n");
      out.write("\t\t\t<form\r\n");
      out.write("\t\t\t\taction=\"http://localhost:8080/yunwon_free/BabyServlet?key=write\"\r\n");
      out.write("\t\t\t\tmethod=\"post\">\r\n");
      out.write("\t\t\t\t<div id=\"diary\">\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label id = \"lab\" for=\"inputTitle\">Title</label> <input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\tclass=\"form-control\" id=\"inputTitle\" name=\"title\" autofocus>\r\n");
      out.write("\t\t\t\t\t</div><br>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-row\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group col-md-6\">\r\n");
      out.write("\t\t\t\t\t\t\t<label id = \"lab\" for=\"inputWeather\">Weather</label> <select\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"inputWeather\" name=\"weather\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option>warm</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option>cool</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option>cold</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option>rainy</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option>snowy</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group col-md-6\">\r\n");
      out.write("\t\t\t\t\t\t\t<label id = \"lab\" for=\"inputState\">State</label> <select\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"inputState\" name=\"state\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option>happy</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option>delighted</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option>joyful</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option>quiet</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option>nervous</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div><br>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label id = \"lab\" for=\"inputContent\">Content</label>\r\n");
      out.write("\t\t\t\t\t\t<textarea class=\"form-control\" id=\"inputContent\" rows=\"4\"\r\n");
      out.write("\t\t\t\t\t\t\tname=\"content\"></textarea>\r\n");
      out.write("\t\t\t\t\t</div><br>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label id = \"lab\" for=\"inputSelf\">To Baby</label> <input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\tclass=\"form-control\" id=\"inputSelf\" name=\"self\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<button type=\"submit\" class=\"btn btn-outline-dark\">Done</button>\r\n");
      out.write("\t\t\t\t\t&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t<button type=\"reset\" class=\"btn btn-dark\">Again</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
